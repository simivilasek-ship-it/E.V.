'use client'
// TODO: migrate from web_vite_backup/src/components/DashboardPanel.jsx
export default function DashboardPanel(props: Record<string, unknown>) {
  return (
    <div className="card p-6 flex items-center justify-center gap-3 text-sm"
      ...
      DashboardPanel — migrace probíhá…
    </div>
  )
}
