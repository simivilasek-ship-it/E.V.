'use client'
// TODO: migrate from web_vite_backup/src/components/PluginStore.jsx
export default function PluginStore(props: Record<string, unknown>) {
  return (
