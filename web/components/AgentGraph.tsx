'use client'
// TODO: migrate from web_vite_backup/src/components/AgentGraph.jsx
export default function AgentGraph(props: Record<string, unknown>) {
  return (
